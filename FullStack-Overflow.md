...
* [ ] Создание лид-формы. Переключить toggle "Создать лендинг". Прверить, что лендинг не существует и отображается сообщение "Необходимо создать лендинг".
...
* [ ] Создание лид-формы. Конструктор лендинга. В поле "Название компании" ввести длинное название. Проверить, что текст обрежется после 30-го символа.  
<img src="img/lending/company.png"/>
...
<img src="img/lending/header.png"/>
...
* [ ] Создание лид-формы. Конструктор лендинга. Нажать на кнопку "Добавить блок" и выбрать "Текст". Проверить, что добавляется поле "Введите текст".
 <img src="img\lending\add_block__text.png">
...
<img src="img/lending/image.png">

* [ ] Создание лид-формы. Конструктор лендинга. Форма загрузки изображений. Добавить изображение формата jpg и размером не более 10 МБ. Проверить, что изображение появилось в разделе "Изображения"  
<img src="img/lending/image_added.png">
...
<img src="img/lead_form/image.png">
...
<img src="img/lead_form/company_empty.png">

* [ ] Создание лид-формы. Оставить название организации слишком большой длины. Проверить, что нельзя создать форму.
<img src="img/lead_form/company_long.png">

* [ ] Создание лид-формы. Оставить заголовок пустым. Проверить, что нельзя создать форму.
<img src="img/lead_form/header_empty.png">

* [ ] Создание лид-формы. Оставить заголовок слишком большой длины. Проверить, что нельзя создать форму.
<img src="img/lead_form/header_long.png">

* [ ] Создание лид-формы. Оставить описание формы пустым. Проверить, что нельзя создать форму.
<img src="img/lead_form/description_empty.png">

* [ ] Создание лид-формы. Сделать описание формы большой длины. Проверить, что нельзя создать форму.
<img src="img/lead_form/description_long.png"> 

* [ ] Создание лид-формы. Выбрать стиль произвольного цвета. Проверить, что стиль карточки изменится соответствующим образом  
<img src="img/lead_form/styles_select.png">  
<img src="img/lead_form/styles_applied.png">

* [ ] Создание лид-формы. Загрузить изображение обложки формата jpg. Проверить, что изображение появилось в шапке карточки.  
<img src="img/lead_form/cover_image.png">
...
<img src="img/lead_form/long_description_empty.png">
...
<img src="img/lead_form/long_description_long.png">

* [ ] Создание лид-формы. Использовать более 2 переносов строк в поле "Длинное описание". Проверить, что ерейти к следующему этапу заполнения формы нельзя.  
<img src="img/lead_form/long_description_LF.png">
...
<img src="img/lead_form/sale_0.png">
...
<img src="img/lead_form/sale_101_percent.png">
...
<img src="img/lead_form/bonus_empty.png">
...
<img src="img/lead_form/bonus_long.png">

* [ ] Создание лид-формы. Нажать на кнопку "Продолжить". Проверить, что никаких предуприждений о том, что что-то заполнено некорректно нет и произошёл переход на этап "Вопросы".

* [ ] Создание лид-формы. Вкладка вопросов. Нажать кнопку "Добавить вопрос". Проверить, что создалась карточка с формой вопроса.

* [ ] Создание лид-формы. Вкладка вопросов. Ввести в поле "Напришите вопрос" текст. Проверить, что на превью лендинга отобразиться текст вопроса.
...
<img src="img/lead_form/answer_text.png">
...
<img src="img/lead_form/answer_new.png">
...
<img src="img/lead_form/answer_drag.png">

* [ ] Создание лид-формы. Вкладка вопроса. Нажать на значёк удаления вопроса (действие необратимо). Проверить, что вопрос удалён.  
<img src="img/lead_form/question_delete.png">
...
<img src="img/lead_form/contacts_delete.png">
...
<img src="img/lead_form/contacts_add.png">
...
<img src="img/lead_form/result_header_empty.png">
...
<img src="img/lead_form/result_header_long.png">
...
<img src="img/lead_form/result_add_number.png">
...
<img src="img/lead_form/result_number_russian_format.png">
...
<img src="img/lead_form/result_promo_long.png">
...
<img src="img/lead_form/settings_empty.png">
...
<img src="img/lead_form/settings_tax_long.png">

* [ ] Создание лид-формы. Вкладка настройки. Нажать кнопку "Сохранить". Проверить, что модальное окно создания формы закрылось и в списке форм появилась новая форма.

* [ ] Раздел лид-форм. Нажать на выпадающий список "Активные". Проверить, что статус показанных лидформ "В архиве", либо такие лид-формы отсутствуют.
